...
db = client[DB_NAME]
collection_users = db['users'] # _id, email, password, domain, name, role, settings: {userTheme, theme, model, googleAccessToken, googleSelectedDetails[]}
...
collection_domain = db['domain'] # _id, name, label, instructions, open_ai_token
